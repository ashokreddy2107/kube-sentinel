...
**Prevention:** Always use `0700` for directories containing sensitive data and `0600` for sensitive files. Explicitly `Chmod` after creation if the creation function (like `MkdirAll` subject to umask) doesn't guarantee exact permissions.
